          ...
          body: BlocBuilder<MovieDetailBloc, MovieDetailState>(
            builder: (context, state) {
              if (state is MovieDetailInitial ||
                  (state is MovieDetailLoadedState &&
                ...
                final errorMessage = () {
                  if (state is LoadMovieDetailFailureState) {
                          ...
                          children: [
                            ...
                            FilledButton(
                              onPressed: () {
                                if (!isAddedWatchlist) {
                                  movieDetailBloc.add(
                                    AddMovieWatchlistEvent(movie: movie),
                                  );
                                } else {
                                  movieDetailBloc.add(
                                    RemoveMovieWatchlistEvent(movie: movie),
                                  );
                                }
                              },
                              child: Row(
                                ...
                                if (state is MovieDetailInitial ||
                                  ...
                                  return Center(
                                    ...
                                    (state
                                        ...
                                        false)) {
                                  return Text(
                                    state.movieRecommendationsErrorMessage ??
                                        '',
                                  );
                                } else if (state is MovieDetailLoadedState &&
                                    state.movieRecommendations != null) {
